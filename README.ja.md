...
Udonite は一人で作り、VRChat SDK の更新で何かが壊れるたびに一人で直しています。支援はその作業と、その上に作られるパッケージ（VRChat ワールド向けの再利用可能なシステム）を支えます。**まだ一つも公開されていません。** 支援者は公開され次第すべて使えます。

[支援する](https://buy.polar.sh/polar_cl_fiMBXRqzbvm0c8qt6xqKKBGbaB0FOQmPMddgn06PRsC)・[検討中のパッケージ](docs/packages.md)（英語）
