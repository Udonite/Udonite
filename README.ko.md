...
Udonite는 한 사람이 만들고 유지보수합니다. VRChat SDK가 갱신되면서 무언가 깨질 때마다 고치는 일도 마찬가지입니다. 후원은 그 작업과, 그 위에 만들어지는 패키지(VRChat 월드용 재사용 가능한 시스템)를 지원합니다. **아직 공개된 것은 하나도 없습니다.** 후원자는 나오는 대로 모두 받으실 수 있습니다.

[후원하기](https://buy.polar.sh/polar_cl_fiMBXRqzbvm0c8qt6xqKKBGbaB0FOQmPMddgn06PRsC) · [검토 중인 패키지 보기](docs/packages.md)(영어)

## 문제 제보

질문이나 잡담은 [Discord](https://discord.gg/8B4q7w6WCq)로 오세요. 한국어로 하셔도 괜찮습니다.

버그, 컴파일되어야 한다고 생각하는데 거부된 문법, SDK 업데이트로 인한 문제는 채팅에 묻히지 않도록 Issues에 남겨 주세요.
